...
public class InSightViewPro1 : MonoBehaviour
{
    ...
    public bool EnAngulo()
    {
        ...
        return anguloAlObjetivo <= anguloDeVision/2;
    }
    ...
    public bool EstaCerca()
    {
        ...
        return distanciaX < distanciaDeAtaque && distanciaY < distanciaDeAtaque / 2; // jony: harcodeado , puede mejorar con una variable attackRadius configurable desde el Inspector

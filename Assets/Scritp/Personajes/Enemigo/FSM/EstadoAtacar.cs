...
public class EstadoAtacar<T> : State<T>
{
    private Coroutine atacarCoroutine;
    private Agent_FSM_Controller _controller;

    public EstadoAtacar(T stateID, Transform NPCAgent, Agent_FSM_Controller controller, FSM<T> fsm) : base(stateID, NPCAgent, fsm)
    {
